; --------------------------------------------------------
; test_strchr_s.asm
;   purpose: tests x86_strchr_s with 12 cases
...
;   case 7:  string with early NULL termination, expect -1
...
;   build  : nasm -w+all -D WINDOWS -f win32   test_strchr_s.asm -o test_strchr_s.obj
;            nasm -w+all -D LINUX   -f elf32   test_strchr_s.asm -o test_strchr_s.obj
;            nasm -w+all -D MACOS   -f macho32 test_strchr_s.asm -o test_strchr_s.obj
; --------------------------------------------------------
